...
> 📦 **This app is now part of the [MCS-Helper-Code-Apps](https://github.com/rafalcaraz/MCS-Helper-Code-Apps) monorepo.** It was originally developed at [rafalcaraz/MCSTranscriptViewer](https://github.com/rafalcaraz/MCSTranscriptViewer) (archived; refer there for pre-merge history). Long-form reference docs (backlog, knowledge, transcript patterns) now live under [`./docs/`](./docs).
...
See [`docs/TRANSCRIPT-PATTERNS.md`](./docs/TRANSCRIPT-PATTERNS.md) for a deeper dive into the activity stream patterns.

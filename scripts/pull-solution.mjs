#!/usr/bin/env node
// Pull the latest shared solution from the currently-selected Dataverse env,
...
//   3. Strip each app's compiled bundle (regenerated by pack-solution)
...
const SOLUTION_UNIQUE_NAME = "MCSHelperCodeApps";

// Each app in the shared solution. Keep in sync with pack-solution.mjs.
// Only `appName` is needed here — pull strips each app's compiled bundle dir
// after unpack since those are regenerated locally by pack-solution.
const APPS = [
  { appName: "msftcsa_mcsconversationviewer_6ae15" },
  { appName: "msftcsa_agentevaluationsviewer_dd752" },
];
